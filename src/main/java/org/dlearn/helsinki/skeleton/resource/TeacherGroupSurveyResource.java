...
public class TeacherGroupSurveyResource {
    ...
    public List<GroupAnswer> getAnswersFromSurvey(@PathParam("class_id") int class_id, @PathParam("group_id") int group_id, @PathParam("survey_id") int survey_id) {
    ...
    public List<Question> getGroupResource(@PathParam("survey_id") int survey_id) {
    	System.out.println("calling group questions");
    	return teacherGroupSurveyAnswerService.getQuestionsFromSurvey(survey_id);
    }
}
